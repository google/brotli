...
static const JNINativeMethod kDecoderMethods[] = {
    {const_cast<char*>("nativeCreate"), const_cast<char*>("([J)Ljava/nio/ByteBuffer;"),
    ...
    {const_cast<char*>("nativePull"), const_cast<char*>("([J)Ljava/nio/ByteBuffer;"),
     reinterpret_cast<void*>(
    ...
    {const_cast<char*>("nativeAttachDictionary"), const_cast<char*>("([JLjava/nio/ByteBuffer;)Z"),
     reinterpret_cast<void*>(
